 ...
 */
package org.candy.updater.misc;
...
public final class Constants {
    ...
    public static final String PROP_BUILD_VERSION = "ro.candy.build.version";
    public static final String PROP_DEVICE = "ro.candy.device";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_RELEASE_TYPE = "ro.candy.buildtype";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "candy.updater.allow_downgrading";
    public static final String PROP_UPDATER_URI = "candy.updater.uri";
    //public static final String PROP_VERSION = "ro.candy.version";
